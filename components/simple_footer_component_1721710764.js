...
*/
Vue.component("simple_footer_component_1721710764", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            EthInspect - Ethereum Transaction Analyzer
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Gain insights into new Ethereum transactions with real-time monitoring and in-depth analysis. EthInspect provides developers and users with a powerful tool to understand the flow of value on the Ethereum blockchain.
                    </div>
                </div>
            </div>
        </footer> 
